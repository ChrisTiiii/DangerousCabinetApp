 ...
 * Time: 2019/3/19 0019 13:33
 * Description:
 */
public class CabinetGoodsAdapter extends BaseQuickAdapter<GoodsItem, BaseViewHolder> {
    private Context context;

    public CabinetGoodsAdapter(Context context, int layoutResId, @Nullable List<GoodsItem> data) {
